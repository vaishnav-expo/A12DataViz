...
d3.csv("state_crime.csv", function(data) {
        ...
        const annotations = [
                ...
                {
                        note: {
                                label: "Year : 2012 Population : 2949131",
                ...
                {
                        note: {
                                label: "Year : 2012 Population : 3590347",
                ...
                {
                        note: {
                                label: "Year : 2012 Population : 9919945",
                                title: "State : Georgia"
                        },
                        x: 410,
                        y: 90,
                ...
                {
                        note: {
                                label: "Year : 2012 Population : 6537334",
                                title: "State : Indiana"
                        },
                        x: 460,
                        y: 220,
...
// Add annotation to the chart
        ...
        svg.append("text")
            ...
            .text("Stacked bar chart of total population of US states in years 2009-2012")
        ...
        svg.append("text")
            ...
            .text("Source - https://corgis-edu.github.io/corgis/csv/state_crime/")

        var color = d3.scaleOrdinal()
            .domain(subcategoriess)
            .range(['#b4e2fc','#6cc1ff','#2c9aff','#396dfa'])
        ...
        var mouseover = function(d) {
                var subcategoriesName = d3.select(this.parentNode).datum().key;
                var subcategoriesValue = d.data[subcategoriesName];
                tooltip
                    .html("Year: " + subcategoriesName + "<br>" + "Population: " + subcategoriesValue)
                    .style("opacity", 1)
        }
